        ...
        >
          <div className="bg-gray-200 p-2 flex items-center">
            ...
            <div className="flex-grow text-center">
              <span className="text-sm font-medium text-gray-600">Problemática</span>
            </div>
          </div>
          <motion.div
            className="p-4"
          ...
          >
            <h2 className="text-2xl font-bold text-blue-600 mb-4">¿Cuál es el problema?</h2>
            <p className="text-gray-700 mb-4">
              La problemática identificada va enfocada en el retraso del habla en niños de primera infancia entre las
              edades de 3 a 4 años, siendo una etapa clave en el desarrollo cerebral de los niños, especialmente en
              habilidades lingüísticas y adquisición de conocimientos gracias a la activación de las neuronas espejo.
            </p>
            <motion.div
            ...
            >
              ...
              <p>
                La educación es un derecho fundamental de todos los niños y niñas, reconocido por la Convención sobre los
